...
SNESpad pad = SNESpad(11, 10, 12); // Create a SNESpad instance, change the pin values to match your wiring (latch, clock, data)
SoftwareSerial vSerial(8, 9, true); // RX, TX, inverse_logic. RX is not used here, as the CDi only communicates on the RTS line
